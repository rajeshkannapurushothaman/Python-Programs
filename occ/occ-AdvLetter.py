...
class occAdvisoryItems(scrapy.Item):
    ID = scrapy.Field()
...
class OccAdvisorySpider(scrapy.Spider):
    name = 'occAdvisory'
    start_urls = ['https://www.occ.gov/news-events/newsroom/index.html?nr=Advisory%20Letter']
    ...
    def parse(self, response):
        ...
        data = '{"Keywords":[],"Topics":[],"NewsTypes":["AdvisoryLetter"],"EarliestPublishDateTime":null,"LatestPublishDateTime":null}'
