...
class occTestimonyItems(scrapy.Item):
    ID = scrapy.Field()
...
class OccTestimonySpider(scrapy.Spider):
    name = 'occTestimony'
    start_urls = ['https://www.occ.gov/news-events/newsroom/index.html?nr=Congressional%20Testimony']
    ...
    def parse(self, response):
        ...
        data = '{"Keywords":[],"Topics":[],"NewsTypes":["CongressionalTestimony"],"EarliestPublishDateTime":null,"LatestPublishDateTime":null}'
