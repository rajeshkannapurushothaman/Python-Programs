...
class occSpeechItems(scrapy.Item):
    ID = scrapy.Field()
...
class OccSpeechSpider(scrapy.Spider):
    name = 'occSpeech'
    start_urls = ['https://www.occ.gov/news-events/newsroom/index.html?nr=Speech']
    ...
    def parse(self, response):
        ...
        data = '{"Keywords":[],"Topics":[],"NewsTypes":["Speech"],"EarliestPublishDateTime":null,"LatestPublishDateTime":null}'
