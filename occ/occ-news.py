...
class occNewsItems(scrapy.Item):
    ID = scrapy.Field()
...
class OccNewsSpider(scrapy.Spider):
    name = 'occNews'
    start_urls = ['https://www.occ.gov/news-events/newsroom/index.html?nr=News%20Release/']
    ...
    def parse(self, response):
        ...
        data = '{"Keywords":[],"Topics":[],"NewsTypes":["NewsRelease"],"EarliestPublishDateTime":null,"LatestPublishDateTime":null}'
